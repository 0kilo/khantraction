...
OUTDIR = ROOT / "solutions" / "phase_a_invariant_channel_comparison"
...
def write_summary(scans: List[Dict[str, object]], named: List[Dict[str, object]]) -> None:
    ...
    lines.append("")
    lines.append("Generated by `analysis/phase_a_invariant_channel_comparison.py`.")
    lines.append("")
    lines.append("## Idea")
    lines.append("")
    lines.append("Use Gram-matrix / singular-value style diagnostics of the angular Jacobian columns as a less chart-fragile comparison than raw determinant language alone.")
    lines.append("")
