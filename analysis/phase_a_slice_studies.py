...
OUTDIR = ROOT / "solutions" / "phase_a_slice_studies"
...
def write_summary(one_d: Dict[str, object], two_d: Dict[str, object]) -> None:
    ...
    lines.append("")
    lines.append("Generated by `analysis/phase_a_slice_studies.py`.")
    lines.append("")
    ...
    lines.append("- Varying phi with theta and rho held fixed should expose the repeated singular slices directly.")
    lines.append("- Varying theta or rho with phi held away from singular values should keep the determinant away from zero.")
    lines.append("- 2D slices with phi fixed at 0 should stay regular; with phi fixed at pi/4 they should collapse onto singular sheets.")
