...
if __name__ == "__main__":
    ...
    os.makedirs("solutions/phase_b_exact_radial_solver/profiles", exist_ok=True)
    ...
    for seed in seeds:
        ...
        # Dump profile
        profile_path = f"solutions/phase_b_exact_radial_solver/profiles/{seed['id']}.csv"
    ...
    with open("solutions/phase_b_exact_radial_solver/run_summary.json", 'w') as f:
