...
def build_comparison(baseline: Dict[str, object], pullback: Dict[str, object], exploratory: Dict[str, object]) -> Dict[str, object]:
    ...
    return {
        "baseline_component_reference": {
            "solver": "analysis/phase_b_full_radial_solver.py",
...
def write_summary_md(comp: Dict[str, object], pullback: Dict[str, object], exploratory: Dict[str, object]) -> None:
    ...
    lines.append("")
    lines.append("Generated by `analysis/phase_b_improved_dynamics_solver.py`.")
    lines.append("")
    lines.append("## Modes")
    lines.append("- component baseline = existing `analysis/phase_b_full_radial_solver.py`")
