...
The first coarse grid scan (`solutions/phase_a/phase_a_parameter_geometry/coarse_scan.csv`) sampled 4913 ordered-angle points at fixed $\omega=0$.
...
- `solutions/phase_a/phase_a_singularity_structure/`
