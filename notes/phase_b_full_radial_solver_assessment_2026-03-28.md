...
- `solutions/phase_b_full_radial_solver/assumptions_and_closure.json`
...
- `solutions/phase_b_full_radial_solver/run_results.csv`
- `solutions/phase_b_full_radial_solver/run_summary.json`
- `solutions/phase_b_full_radial_solver/assumptions_and_closure.json`
- `solutions/phase_b_full_radial_solver/summary.md`
- `solutions/phase_b_full_radial_solver/profiles/*.csv`
...
From `solutions/phase_b_full_radial_solver/run_summary.json`:
