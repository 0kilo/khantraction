...
Outputs are in:
- `solutions/phase_b_improved_dynamics/baseline_pullback/`
- `solutions/phase_b_improved_dynamics/exploratory_directional/`
- `solutions/phase_b_improved_dynamics/comparison_summary.json`
- `solutions/phase_b_improved_dynamics/summary.md`
...
From `solutions/phase_b_improved_dynamics/baseline_pullback/run_summary.json`:
- seed count: `39`
- success count: `39`
...
From `solutions/phase_b_improved_dynamics/exploratory_directional/run_summary.json`:
- seed count: `39`
- success count: `39`
- regularity-ok count: `39`
- horizon hits: `0`
...
- `solutions/phase_b_improved_dynamics/baseline_pullback/run_results.csv`
- `solutions/phase_b_improved_dynamics/exploratory_directional/run_summary.json`
- `solutions/phase_b_improved_dynamics/exploratory_directional/run_results.csv`
