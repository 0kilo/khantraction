...
- **1D Phi Slice**: Shows dramatic mass fluctuations ranging from $M \approx 0.02$ to $M > 2.0$, perfectly aligning with the singular-sheet architecture discovered in Phase A.
